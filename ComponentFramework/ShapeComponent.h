...
public:
	ShapeComponent(Component* parent_, const GEOMETRY::Sphere& sphere_);
	// TODO for Assignment 1:
	ShapeComponent(Component* parent_, const GEOMETRY::Cylinder& cylinder_);
	ShapeComponent(Component* parent_, const GEOMETRY::Capsule& capsule_);
	ShapeComponent(Component* parent_, const GEOMETRY::Box& box_); 
